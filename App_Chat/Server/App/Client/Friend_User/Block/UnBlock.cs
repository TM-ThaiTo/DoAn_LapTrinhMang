...
namespace Server.App.Client.Friend_User.Block
{
    public class UnBlock
    {
        ...
        {
            var ubu = context.FriendLists.SingleOrDefault(un => un.UserID1 == id_yeuCau && un.UserID2 == id_un && un.Status == "Block");
        ...
        public void Un_Block_All(App_Chat_DB context, Socket clientSocket, int id_yeuCau)
        {
            ...
            var blockedEntries = context.FriendLists.Where(un => un.UserID1 == id_yeuCau).ToList();
